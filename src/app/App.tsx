...
export default function App() {
  ...
  return <div className={`app ${isDisplay ? 'display' : ''}`}>
    ...
    {!isDisplay && <div className="bottom-line"><span>{t("PRECISION ON THE MAT.")}</span><span className="author-credit">Иванюшкин Никита</span><span>{t("TATAMI / MATCH CONTROL")}<span className="live-dot"/></span></div>}
